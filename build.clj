...
(def lib 'com.sturdystats/sturdy-numpy)
...
(defn jar
  ...
  (b/write-pom
   {:class-dir class-dir
    ...
    :src-dirs  ["src"]
    :pom-data
    [[:description "Read NumPy .npy files into idiomatic Clojure data (sturdy-numpy)."]
     [:url "https://github.com/Sturdy-Statistics/sturdy-numpy"]
     [:licenses
      [:license
     ...
     [:scm
      ...
      [:url "https://github.com/Sturdy-Statistics/sturdy-numpy"]
      [:connection "scm:git:https://github.com/Sturdy-Statistics/sturdy-numpy.git"]]]})
